...
- diagnostic traced-state accepted-policy anchoring via `--policy-anchor-data` / `--policy-anchor-weights`;
...
1. Do not promote `2026050603`, `2026050605`, `2026050608`, `2026050610`, `2026050611`, `2026050612`, `2026050613`, `2026050614`, `2026050615`, `2026050701`, `2026050702`, `2026050703`, `2026050801`, or `2026050802`; none improved the accepted AI under full gates or the required `97/109` reduced trace gate.
...
3. Keep `--runtime-wrapper-modes none,runtime-survivors-only,tactical-downweight`, `--runtime-tactical-rewrite-weights`, `--action-retention-weights`, `--early-forward-safety-weights`, `--early-forward-anchor-weights`, and `--policy-anchor-weights` available for diagnostics, but stop spending mainline budget on open-start wrapper handling, action retention, early-forward downweighting, broad early-forward anchoring, or tiny traced-state anchor sweeps alone; the fixed implementations either stayed behavior-invisible, failed full standard gates, or made cross-seed trade-offs without promotion.
...
5. The next training/search hypothesis should preserve behavior visibility while preventing fragile-seed regressions, but it should not be another one-knob anchor sweep. If continuing the anchor idea, first build a broader multi-candidate trace dataset from aligned low-pressure current-policy decisions around several failed seeds, then test one reduced gate before any full promotion check. Otherwise pivot back to the sparse-reward self-play objective/start-state mix and look for a larger behavioral change that is evaluated immediately on `19/31` plus `97/109`.
