...
1. Do not promote `2026050603`, `2026050605`, `2026050608`, `2026050610`, `2026050611`, `2026050612`, `2026050613`, `2026050614`, `2026050615`, `2026050701`, `2026050702`, `2026050703`, `2026050801`, `2026050802`, or `2026050901`; none improved the accepted AI under full gates or the required `97/109` reduced trace gate.
...
3. Keep `--runtime-wrapper-modes none,runtime-survivors-only,tactical-downweight`, `--runtime-tactical-rewrite-weights`, `--action-retention-weights`, `--early-forward-safety-weights`, `--early-forward-anchor-weights`, `--policy-anchor-weights`, and `--anchor-neighbor-radius` available for diagnostics, but stop spending mainline budget on open-start wrapper handling, action retention, early-forward downweighting, broad early-forward anchoring, or traced-state anchor expansion alone; the fixed implementations either stayed behavior-invisible, failed full standard gates, or made cross-seed trade-offs without promotion.
...
5. The next training/search hypothesis should pivot back to sparse-reward self-play objective or start-state mix changes that can create a larger behavior-visible policy shift without relying on anchors. Evaluate the first candidate immediately on `19/31` plus `97/109` with `--trace-gate --decision-trace-gate`; only run a full promotion check if both standard safety and fragile-holdout behavior improve together.
