...
1. Do not promote `2026050603`, `2026050605`, `2026050608`, `2026050610`, `2026050611`, `2026050612`, `2026050613`, `2026050614`, `2026050615`, `2026050701`, `2026050702`, or `2026050703`; none improved the accepted AI under full gates or the required `97/109` reduced trace gate.
...
3. Keep `--runtime-wrapper-modes none,runtime-survivors-only,tactical-downweight`, `--runtime-tactical-rewrite-weights`, `--action-retention-weights`, and `--early-forward-safety-weights` available for diagnostics, but stop spending mainline budget on open-start wrapper handling, action retention, or early-forward downweighting alone; the fixed implementations either stayed behavior-invisible, failed full standard gates, or made the `97/109` forward-loss pattern worse.
...
5. The next training/search hypothesis should preserve behavior visibility while preventing early low-pressure full-forward regressions. Test candidates against a reduced trace gate that reports first-divergence actions on `97/109`; prefer candidates whose first divergences are not current `8` becoming candidate non-forward actions in low-pressure states. Since global action retention did not cross a useful behavior threshold and simple early-forward downweighting was counterproductive, prioritize a direct accepted-policy anchor or first-divergence-aware KL/BC slice on traced low-pressure gate states before expanding architecture.
