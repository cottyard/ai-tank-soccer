...
1. Do not promote `2026050603`, `2026050605`, `2026050608`, `2026050610`, `2026050611`, `2026050612`, `2026050613`, `2026050614`, `2026050615`, `2026050701`, `2026050702`, `2026050703`, or `2026050801`; none improved the accepted AI under full gates or the required `97/109` reduced trace gate.
...
3. Keep `--runtime-wrapper-modes none,runtime-survivors-only,tactical-downweight`, `--runtime-tactical-rewrite-weights`, `--action-retention-weights`, `--early-forward-safety-weights`, and `--early-forward-anchor-weights` available for diagnostics, but stop spending mainline budget on open-start wrapper handling, action retention, early-forward downweighting, or broad early-forward anchoring alone; the fixed implementations either stayed behavior-invisible, failed full standard gates, or made cross-seed trade-offs without promotion.
...
5. The next training/search hypothesis should preserve behavior visibility while preventing early low-pressure full-forward regressions. Test candidates against a reduced trace gate that reports first-divergence actions on `97/109`; prefer candidates whose first divergences are not current `8` becoming candidate non-forward actions in low-pressure states. Since global action retention did not cross a useful behavior threshold, simple early-forward downweighting was counterproductive, and broad early-forward anchoring failed full standard seed `71`, prioritize a narrower first-divergence-aware KL/BC slice built from traced gate states before expanding architecture.
